...
import { ShopifyStorefrontClient } from "./storefront-client.service";

@Module({})
export class ShopifyStorefrontClientModule {
  public static forFeature(
    options?: ShopifyModuleFeatureOptions
  ): DynamicModule {
    return {
      module: ShopifyStorefrontClientModule,
      providers: options
        ? this._createOptionsProviders(options)
        : this._createGlobalOptionsProviders(),
      exports: [ShopifyStorefrontClient],
    };
  }
